...
const add_values = (list) => {
  ...
  const res = list.map((item) => {
    return {
      ...
      category_id: 2,
      stock_quantity: getRandomInt(1, 20),
    };
  });
...
const updatedList = add_values(cpus);
fs.writeFile('cpus.json', JSON.stringify(updatedList, null, 2), (err) => {
  if (err) throw err;
  console.log('the data has been mutated and written to output.json');
});
