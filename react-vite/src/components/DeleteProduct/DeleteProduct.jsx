  ...
  return (
    <>
      {theme === 'light' ? (
        ...
        <div className="delete-product-container-dark">
          <div className="delete-product-title-dark">
            <h1 className='delete-product-title-1-dark'>Confirm Delete </h1>
            <h3 className='delete-product-title-2-dark'>Are you sure you want to delete this listed product?</h3>
          </div>
          <div className="delete-product-delete-cancel-container">
            <button className="delete-product-button" onClick={confirmDelete}>
              <span className="delete-product-button__text">Delete</span>
