  ...
  return (
    <div key={key}>
      {theme === 'light' ? (
        ...
        <div className="landing-page-container-dark">
          <div className="main-logo-intro-container-dark">
            <img src="/main-logo-dark-mode.svg" alt="" className="main-logo-dark" />
            <div className="intro-container-dark">
              <p className="intro-dark">
                At RigBuild, we understand that every great PC starts with the perfect parts. Whether
                you&apos;re building a powerful gaming rig, a reliable workstation, or upgrading your current
                setup, we have everything you need to create the PC of your dreams.
              </p>
              <ul className="list-of-categories-dark">
                {isLoaded &&
                  categories.map((category) => (
                    <li key={category.id} className="category-dark">
                      <span className="category-name-dark">{category.name}</span>: {category.description}
                    </li>
                  ))}
              </ul>
            </div>
          </div>
          <div className="landing-links-buttons-dark">
            <div className="landing-page-buttons-dark">
              <NavLink to="/products" className="view-all-products-button-container-dark">
                <button className="view-all-products-button-dark">
                  <svg viewBox="0 0 24 24" className="arr-2-dark" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"></path>
                  </svg>
                  <span className="text-dark">SHOP NOW</span>
                  <span className="circle-dark"></span>
                  <svg viewBox="0 0 24 24" className="arr-1-dark" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"></path>
                  </svg>
                </button>
              </NavLink>
              <div className="login-signup-buttons-container-dark">
                <div>
                  <OpenModalMenuItem
                    itemText={
                      <>
                        <button className="login-button-dark" id="user-button-dark">
                          Login
                          <div className="arrow-wrapper-dark">
                ...
                <div>
                  <OpenModalMenuItem
                    itemText={
                      <>
                        <button className="signup-button-dark" id="user-button-dark">
                          Signup
                          <div className="arrow-wrapper-dark">
                            <div className="arrow-dark"></div>
                          </div>
